...
const ListEmpl = () => {
    ...
    const headerElements = {firstName:"First name", lastName:"Last name", dateOfBirth: "Date of birth"};
        ...
        <div className="employee-table__content">
            <h3 className="employee-table__content-title">List of current Employees</h3>
              <div className="employee-table__content-table">
                { isUpload &&
                  <Table  bodyElements={items} optionsTable={optionsTable} headerElements={headerElements} />
                }
              </div>
        </div>
        </div>
